{
  x86_64-linux = {
    "docker.io/manifestdotbuild/manifest:latest" = {
      ref = "docker.io/manifestdotbuild/manifest@sha256:d6b4ab3869186424522bddf367c6682e808e98448feff1f96236b7614f26359e";
      sha256 = "sha256-UkDbYNLOA5Gf6n9Gt+P1qgttOVvJatYnt0Nz8uP2zic=";
    };
    ...
    "ghcr.io/toeverything/affine:stable" = {
      ref = "ghcr.io/toeverything/affine@sha256:c312116a134184947d98749c8a8e29f4e3bc97f4f2a51c9a3497f9baea2eec2b";
      sha256 = "sha256-hRn0xoaOZjHcfiFsVALOfGl3PELQJAv+1CS2CA4Pftw=";
    };
    ...
    "ghcr.io/home-assistant/home-assistant:stable" = {
      ref = "ghcr.io/home-assistant/home-assistant@sha256:31076d37e3b7dc9681b32d892aa4413fa866c9a90e5c8a50324b397dce415d17";
      sha256 = "sha256-llQHOp8ofE3u+nXA/JKnuiaRXJxWhS4vhfeZVudXnsk=";
    };
  ...
  aarch64-linux = {
    "ghcr.io/toeverything/affine:stable" = {
      ref = "ghcr.io/toeverything/affine@sha256:adb3cea3eb4a50a6116dbab7dc045252b54ede3e73828a85a58daf78da3b1f6d";
      sha256 = "sha256-GhsCoANuY0EG+PnCRGxPwCc5M6ptx9Bkw6m/UYQUc1E=";
    };
    "docker.io/itzcrazykns1337/perplexica:main" = {
    ...
    "ghcr.io/home-assistant/home-assistant:stable" = {
      ref = "ghcr.io/home-assistant/home-assistant@sha256:134bdc1b5f3d32f201987966134fc6edbba0809c6d5100651b28dc653f443d39";
      sha256 = "sha256-P/h3gj0ZcUD15eW1h5uJxzVvtLnEH20yo3qDQ4vCCdE=";
    };
    "docker.io/openspeedtest/latest:latest" = {
    ...
    "docker.io/manifestdotbuild/manifest:latest" = {
      ref = "docker.io/manifestdotbuild/manifest@sha256:52534722df9bef01d036d2b33a3cf4e917c38578440dc5180b27c5dccf3f573b";
      sha256 = "sha256-Yl823XZhFS597o6b0qt6MGAQoOf96MmjXPj2w+h1Iiw=";
    };
  };
  armv7l-linux = {
    "ghcr.io/danielbrendel/hortusfox-web:latest" = {
